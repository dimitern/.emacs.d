(custom-set-variables
 ...
 '(ein:url-or-port '("http://127.0.0.1:8889"))
 '(ein:urls '("http://127.0.0.1:8889"))
 ...
 '(flycheck-disabled-checkers '(python-pylint python-pycompile))
 '(flycheck-executable-find 'flycheck-default-executable-find)
 ...
 '(flycheck-pycheckers-checkers '(flake8 pyflakes))
 ...
 '(flycheck-python-mypy-args '("--follow-imports=silent" "--ignore-missing-imports"))
 '(flycheck-python-mypy-executable "mypy")
 '(flycheck-syntax-check-failed-hook '(ignore))
 ...
 '(highlight-tail-colors
   '(("#073642" . 0)
     ...
     ("#93115C" . 85)
     ("#073642" . 100)))
 '(hippie-expand-ignore-buffers '("^ \\*.*\\*$" dired-mode))
